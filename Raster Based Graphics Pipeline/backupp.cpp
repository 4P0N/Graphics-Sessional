...
//
//            if(changedX=="none"){
//                Z1=z1+((z1-z2)/(y1-y2))*(currY-y1);
//                Z2=z2+((z2-z3)/(y2-y3))*(currY-y2);
//            }else if(changedX=="X1"){
//                Z1=z3+((z3-z1)/(y3-y1))*(currY-y3);
//                Z2=z2+((z2-z3)/(y2-y3))*(currY-y2);
//            }else if(changedX=="X2"){
//                Z1=z1+((z1-z2)/(y1-y2))*(currY-y1);
//                Z2=z3+((z3-z1)/(y3-y1))*(currY-y3);
//            }
//            double leftZ,rightZ;
//            if(minX==X1){
//                leftZ=Z1;
...
//            else rightScanline=round((maxX-leftX)/dx);
//
//            cout<<leftScanline<<" --------- "<<rightScanline<<endl;
//
//            double inc=(rightZ-leftZ)/(rightScanline-leftScanline);
//            int l=0;
//            for(int k=leftScanline;k<rightScanline;k++)
//            {
//                double Z=leftZ+l*inc;
//                l++;
//                if(Z>frontZ && Z<zBuffer[j][k]){
//                    zBuffer[j][k]=Z;
//                    image.set_pixel(j,k,t.color[0],t.color[1],t.color[2]);
//                }
//            }z
        }
    }
    ...
    if (!bufFile.is_open()) {
        cout<< "Problem opening the stage3 file!\n"<<endl;
    }
